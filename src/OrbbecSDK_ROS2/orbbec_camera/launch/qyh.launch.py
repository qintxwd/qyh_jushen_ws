...
def generate_launch_description():
    ...
    ld = LaunchDescription([        
        TimerAction(period=0.1, actions=[GroupAction([left_camera])]), # The primary camera should be launched at last
        TimerAction(period=5.0, actions=[GroupAction([right_camera])]), # The primary camera should be launched at last
        TimerAction(period=10.0, actions=[GroupAction([head_camera])]), # The primary camera should be launched at last
    ])
