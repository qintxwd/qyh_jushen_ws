...
def generate_launch_description():
    # 获取配置文件路径
    pkg_dir = get_package_share_directory('qyh_shutdown')
    config_file = os.path.join(pkg_dir, 'config', 'shutdown_params.yaml')
    ...
    qyh_shutdown_node = Node(
        package='qyh_shutdown',
        executable='qyh_shutdown_node',
        name='qyh_shutdown_node',
        output='screen',
        parameters=[
            config_file,
            {
